"""Lightweight HTTP proxy for the optional flood camera service."""
...
def proxy_flood_camera(request: HttpRequest, path: str = "") -> HttpResponse:
    """Forward a flood monitoring request without importing ML dependencies."""
    ...
    try:
        ...
        return _error_response(
            "Flood camera monitoring timed out",
            "flood_camera_timeout",
            504,
        )
